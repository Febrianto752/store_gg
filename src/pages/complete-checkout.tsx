  ...
  return (
    <section className="complete-checkout mx-auto pt-lg-145 pb-lg-145 pt-100 pb-80">
      <div className="container-fluid">
        <div className="text-center">{CheckoutCompleteIcon()}</div>
        ...
        <div className="button-group d-flex flex-column mx-auto">
          ...
          <a
            ...
            href="https://wa.me/6282111025436?text=Saya%20sudah%20melakukan%20pembayaran"
            role="button"
          >
            WhatsApp ke Admin
          </a>
